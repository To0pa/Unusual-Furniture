...
public class UnusualFurnitureClient {
	...
	public static void init() {
		...
		UFObjects.BENCH_BLOCKS.forEachEntry((block, reLo) -> CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(), block));
		UFObjects.CURTAIN_BLOCKS.forEachEntry((block, reLo) -> CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(), block));
		UFObjects.FLOOR_LAMP_BLOCKS.forEachEntry((block, reLo) -> CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(), block));
		UFObjects.LAMP_BLOCKS.forEachEntry((block, reLo) -> CommonAbstraction.INSTANCE.registerRenderType(RenderType.translucent(), block));
		UFObjects.POT_BLOCKS.forEachEntry((block, reLo) -> CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(), block));
		CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(),
		...
		UFObjects.TABLE_LAMP_BLOCKS.forEachEntry((block, reLo) -> CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(), block));
		CommonAbstraction.INSTANCE.registerRenderType(RenderType.cutoutMipped(),
				UFObjects.MANHOLE,
