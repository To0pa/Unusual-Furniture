...
@ApiStatus.Internal
public class FabricUFRegistryEntry<T> implements UFRegistryEntry<T> {

	private final ResourceLocation id;
	private final T value;

	private FabricUFRegistryEntry(ResourceLocation id, T value) {
		this.id = id;
		this.value = value;
	}

	public static <T, I extends T> FabricUFRegistryEntry<I> of(
			Registry<T> registry, ResourceLocation id, Supplier<I> supplier) {
		return new FabricUFRegistryEntry<>(id, Registry.register(registry, id, supplier.get()));
	}
